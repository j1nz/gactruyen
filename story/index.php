<?php
    ...
    echo $permalinks[0] .'<br>';
    echo $permalinks[1] .'<br>';
    echo $permalinks[2] .'<br>';
    echo $permalinks[3];

    if (isset( $permalinks ) )
	{
		if ( $permalinks[3] != null ) {
			require_once(ABSPATH .'/include/function/class-load.php');

			$loaded = new Load();

			$loaded->load($permalinks[3], '', '');
		} else { ?>
